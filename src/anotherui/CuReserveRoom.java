...
public class CuReserveRoom extends JFrame {
	...
	public CuReserveRoom(MessageAndShowNewsWindow messageAndShowNewsWindow1) {
		...
		searchEmptyRoomBu.setBounds(91, 104, 107, 33);
		...
		reserveRoomBu.setBounds(204, 103, 108, 34);
		
		JLabel lblNewLabel_1 = new JLabel("\u987E\u5BA2\u53F7\uFF1A");
		lblNewLabel_1.setBounds(370, 108, 57, 25);
		
		searchCustomerNoText = new JTextField();
		searchCustomerNoText.setBounds(449, 110, 66, 21);
		...
		JButton returnHouseSystemBu = new JButton("\u8FD4\u56DE\u4E3B\u9875");
		returnHouseSystemBu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				messageAndShowNewsWindow.setVisible(true);
				CuReserveRoom.this.dispose();
			}
		});
